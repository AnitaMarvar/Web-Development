...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="talk">
            <h2>Learn yoga anywhere any time</h2>
            <div class="quoteOne">
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy 
                ...
                in the 1960s with the release of Letraset sheets </p></div></div>
        </div>
            ...
            <div class="col-12 col-lg-4 col-md-4 ">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="serviceDetails.php" class="btn btn-outline-dark">Go somewhere</a>
                    </div>
